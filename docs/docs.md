...
An Orb policy can be written in either JSON or YAML, and has three top level sections: “handlers”, “input” and “kind”.
...
- deep_sample_rate: *int [0,100]. Default: 100 (per second)*. <br><br>
- num_periods: *int [2,10]. Default: 5*. <br><br>
- topn_count: *int.  Default: 10*. <br><br>
...
=== "DNS"
      ...
      **Filter Options**: <br>
        ...
        - only_rcode: *int*. <br>
         - 0: NoError (DNS Query completed successfully) <br>
         - 2: SERVFAIL (Server failed to complete the DNS request) <br>
         - 3: NXDOMAIN (Domain name does not exist) <br>
         - 5: REFUSED (The server refused to answer for the query) <br>
        - only_qtype: *str* <br>
        - answer_count: *int* <br>
        - only_qname_suffix: *str* <br>
        - only_dnssec_response: *bool* <br>
        - dnstap_msg_type: *str* <br> (nao funciona com  pcap)
